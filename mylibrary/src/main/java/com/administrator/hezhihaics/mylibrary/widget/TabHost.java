package com.administrator.hezhihaics.mylibrary.widget;
...
public class TabHost {
    ...
    private void initView() {
        ...
        RelativeLayout.LayoutParams rootViewLp = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
