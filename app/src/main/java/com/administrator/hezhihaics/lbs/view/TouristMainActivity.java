...
import com.administrator.hezhihaics.lbs.adapter.ExampleOneAdapter;
...
public class TouristMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        initToolBar();
        Toast.makeText(this, TouristMainActivity.getSHA1(TouristMainActivity.this), Toast.LENGTH_SHORT).show();
        Log.e("SHA1", TouristMainActivity.getSHA1(TouristMainActivity.this));
        //System.out.println("SHA1：" + TouristMainActivity.getSHA1(TouristMainActivity.this));
    }
    ...
    private void initView() {
        ...
        tabContainerView.setAdapter(new DefaultAdapter(this, fragments, getSupportFragmentManager(),
                getResources().getStringArray(R.array.touristArray),
